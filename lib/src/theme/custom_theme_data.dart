...
final TextTheme textThemeLight = TextTheme(
  titleLarge: GoogleFonts.notoSans(fontSize: 20, fontWeight: FontWeight.w700, letterSpacing: 0.15, color: AppColor.textColor),
  ...
  labelLarge: GoogleFonts.notoSans(fontSize: 16, fontWeight: FontWeight.w500, color: AppColor.textLightGreyColor),
  labelSmall: GoogleFonts.notoSans(fontSize: 10, fontWeight: FontWeight.w500, color: AppColor.textLightGreyColor),
  labelMedium: GoogleFonts.notoSans(fontSize: 14, fontWeight: FontWeight.w500, color: AppColor.textColor),
);

final TextTheme textThemeDark = TextTheme(
  titleLarge: GoogleFonts.notoSans(fontSize: 20, fontWeight: FontWeight.w700, letterSpacing: 0.15, color: AppColor.textColorDark),
